...
/******** Shared compilation directives for this module which have to be activated or inhibited in each header files where they are necessary ********/
#define       messagesON_ALS                    // also defined in Functions.h
